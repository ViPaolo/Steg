...
class SteganographyGUI(ctk.CTk):
    def __init__(self):
        ...
        self.output_entry = ctk.CTkEntry(self.output_frame, width=400) #Entry for the output path
    ...
    ## UI defined, we now need to create commands.
    ...
    def browse_input(self):
        ...
        if filename: #If filename exist, I update the string in the box
            ...
            if self.same_output_var.get(): #If the value is changed, it updates the path.
    ...
    def update_output_path(self):
        ...
        if input_path: #if the input path exists, it exracts the parts.
